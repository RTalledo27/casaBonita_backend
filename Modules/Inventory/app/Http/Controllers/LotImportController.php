...
class LotImportController extends Controller
{
    ...
    public function import(Request $request): JsonResponse
    {
        ...
        try {
            $result = $this->lotImportService->processExcel($request->file('file'));
    ...
    public function downloadTemplate(): StreamedResponse
    {
        try {
            ...
            // Definir headers (incluyendo nueva manzana B como ejemplo)
            $headers = [
            ...
            $exampleRow = [
                ...
                '3000.00', '500.00', '30688.00', '852.44', '731.75', '757.14', 
