...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('employees', function (Blueprint $table) {
            ...
            $table->string('contract_type')->nullable(); // PLAZO_FIJO, INDEFINIDO
            $table->string('work_schedule')->nullable();
            $table->string('social_security_number')->nullable(); // ESSALUD
            $table->string('afp_code')->nullable();
            $table->string('cuspp')->nullable();
            $table->string('health_insurance')->nullable(); // EPS
